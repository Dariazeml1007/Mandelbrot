...
Компонент	Формула	Особенность	Диапазон
Красный (R)	(iter * 197) & 0xFF	Простое число 197 создает хаотичный паттерн	0-255
Зеленый (G)	(iter * 237) & 0xFF	Число 237 дает хороший цветовой разброс	0-255
Синий (B)	(iter * 255) & 0xFF	Максимальное значение байта для плавных переходов	0-255
