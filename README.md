...
|----------------------|---------------------|---------------------|---------------------|
| **Размер кода**      | 34 инструкции       | 24 инструкции       | -29% размера        |
| **Регистры XMM**     | 6                   | 7                   | +1 регистр         |
| **Условные переходы**| 3 branches          | 2 branches          | -33% ветвлений     |
| **Критический путь** | 5 зависимых операций| 4 зависимых операции| +20% IPC           |
| **Векторизация**     | ❌ Нет              | ⚡ Частичная        | +15-25% скорости   |
| **Память**          | 8 обращений         | 5 обращений         | -37% loads/stores  |
...
| **Исп. регистров**      | `5 xmm`                | `6 xmm`                | Лучшее распараллеливание |
| **Инструкции**          | 34                      | 24 (-30%)              | Меньше накладных расходов|
| **Условные переходы**   | 6 branches              | 4 branches (-33%)      | Проще предсказание       |
| **Инициализация**       | Избыточные операции     | Минимальная            | Быстрый старт            |
